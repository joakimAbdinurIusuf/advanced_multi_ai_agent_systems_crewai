...
files = {
    'agents_project_progress_report': 'config/agents_project_progress_report.yaml',
    'tasks_project_progress_report': 'config/tasks_project_progress_report.yaml'
}
...
agents_config = configs['agents_project_progress_report']
tasks_config = configs['tasks_project_progress_report']
...
# Save the raw result as markdown
with open('outputs/project_progress_report.md', 'w') as f:
    f.write(result.raw)
print(f"Project progress report saved to: outputs/project_progress_report.md")

# Save usage metrics as CSV
df_usage_metrics.to_csv('outputs/usage_metrics.csv', index=False)
print(f"Usage metrics saved to: outputs/usage_metrics.csv")
